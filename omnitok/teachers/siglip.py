...
_SIGLIP_CONFIGS = {
    ...
    "siglip_vit_l16_256": {"embed_dim": 1024, "patch_size": 16, "img_size": 256, "timm": "vit_large_patch16_siglip_256"},
    "siglip_vit_so400m_14_384": {"embed_dim": 1152, "patch_size": 14, "img_size": 384, "timm": "vit_so400m_patch14_siglip_384"},
}
...
class SigLIPTeacher(BaseTeacher):
    ...
    def __init__(self, model_name: str = "siglip_vit_l16_256", device: Optional[str] = None) -> None:
        ...
        if model_name not in _SIGLIP_CONFIGS:
            raise ValueError(
                f"Unknown SigLIP model: {model_name}. "
                f"Available: {list(_SIGLIP_CONFIGS.keys())}"
            )
